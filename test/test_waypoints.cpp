...
//     node_->declare_parameter("goal_x", 0.5);
//     node_->declare_parameter("goal_y", 0.5);

//     // Get parameter values
//     goal_x_ = node_->get_parameter("goal_x").as_double();
//     goal_y_ = node_->get_parameter("goal_y").as_double();

//     RCLCPP_INFO(node_->get_logger(), "Testing with goal: (%f, %f)", goal_x_,
//                 goal_y_);

//     client_ = rclcpp_action::create_client<Waypoint>(node_,
//     "tortoisebot_as"); odom_sub_ =
//     node_->create_subscription<nav_msgs::msg::Odometry>(
//         "/odom", 10,
//         std::bind(&TestWaypoints::odom_callback, this,
//         std::placeholders::_1));
...
//   rclcpp_action::Client<Waypoint>::SendGoalOptions();
...
//         EXPECT_TRUE(result.result->success) << "Robot failed to reach the
//         goal"; EXPECT_TRUE(check_position())
...
//             << "Robot unexpectedly succeeded in reaching an unreachable
//             goal";
//       }
//       return;
//     }
